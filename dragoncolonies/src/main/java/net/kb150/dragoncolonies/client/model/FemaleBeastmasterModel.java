...
public class FemaleBeastmasterModel extends CitizenModel<AbstractEntityCitizen> {
    ...
    public FemaleBeastmasterModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createMesh() {
        ...
        // Ponytail mit den neuen zeitsparenden UV-Mappings
        PartDefinition ponytail = head.addOrReplaceChild("Ponytail", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
        ponytail.addOrReplaceChild("ponyTailTip_r1", CubeListBuilder.create().texOffs(26, 10).addBox(0.0F, 0.0F, 0.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-0.5F, -25.0F, 4.8F, 0.2231F, 0.0F, 0.0F));
        ponytail.addOrReplaceChild("ponytailBase_r1", CubeListBuilder.create().texOffs(24, 9).addBox(0.0F, 0.0F, 0.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, -28.0F, 2.0F, 0.5577F, 0.0F, 0.0F));

        PartDefinition Weldingmask = head.addOrReplaceChild("Weldingmask", CubeListBuilder.create(), PartPose.offset(0.0F, -2.6F, 0.0F));
        Weldingmask.addOrReplaceChild("band_r_r1", CubeListBuilder.create().texOffs(104, 0).addBox(-4.01F, -4.0F, -4.0F, 0.0F, 1.0F, 8.0F, new CubeDeformation(0.05F)).texOffs(104, 0).addBox(4.26F, -4.0F, -4.0F, 0.0F, 1.0F, 8.0F, new CubeDeformation(0.05F)), PartPose.offsetAndRotation(0.0F, 0.0F, -1.0F, -0.3927F, 0.0F, 0.0F));
        Weldingmask.addOrReplaceChild("band_back_r1", CubeListBuilder.create().texOffs(104, 0).addBox(4.01F, -4.0F, -4.0F, 0.0F, 1.0F, 8.0F, new CubeDeformation(0.05F)), PartPose.offsetAndRotation(0.25F, 1.75F, 0.0F, 0.0F, -1.5708F, 0.0F));
        Weldingmask.addOrReplaceChild("band_l_r1", CubeListBuilder.create().texOffs(104, 0).addBox(4.01F, -4.0F, -4.0F, 0.0F, 1.0F, 8.0F, new CubeDeformation(0.05F)), PartPose.offsetAndRotation(0.25F, -1.25F, 0.0F, 0.0F, 1.5708F, 0.0F));

        PartDefinition mask = Weldingmask.addOrReplaceChild("mask", CubeListBuilder.create(), PartPose.offset(0.25F, -4.6536F, -2.4201F));
        mask.addOrReplaceChild("mask_r1", CubeListBuilder.create().texOffs(78, 41).addBox(-4.5F, -1.1619F, -2.5868F, 9.0F, 9.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.7453F, 0.0F, 0.0F));
        ...
        // Brust mit dem neuen UV-Mapping (17, 18)
        body.addOrReplaceChild("breast", CubeListBuilder.create()
            .texOffs(64, 49).addBox(-3.0F, 1.8938F, -5.716F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(17, 18).addBox(-3.0F, 1.8938F, -5.716F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.25F)), 
        ...
        right_arm.addOrReplaceChild("normal", CubeListBuilder.create()
            ...
            .texOffs(112, 20).addBox(-2.0F, 4.0F, -2.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.4F)), 
            PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        right_hook.addOrReplaceChild("hook_cube_r1", CubeListBuilder.create()
            .texOffs(114, 0).addBox(-1.0F, 9.0F, -2.5F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(110, 0).addBox(-1.0F, 6.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(42, 17).addBox(-1.5F, -2.0F, -1.5F, 2.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), 
        ...
        left_arm.addOrReplaceChild("normal", CubeListBuilder.create()
            ...
            .texOffs(96, 20).addBox(-1.0F, 4.0F, -2.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.4F)), 
            PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        left_hook.addOrReplaceChild("hook_cube_r2", CubeListBuilder.create()
            .texOffs(114, 0).addBox(0.0F, 9.0F, -2.5F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(110, 0).addBox(0.0F, 6.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(34, 49).addBox(-0.5F, -2.0F, -1.5F, 2.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), 
            PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.2618F));
